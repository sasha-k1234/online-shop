...
function AppLes02() {
  ...
  // const repo = [];
  // for (let i = 0; i < 10; i++) {
  //   repo.push({value1: Math.random(), value2: Math.random()});
  // }
...
//   const repoToView = products.map((el, index) => (
//     <Item num={index} content={el}></Item>
//   ));

  return (

    <EventComponent text="Click me"></EventComponent>

    // <div className="container">
    //   {repoToView}
    //   {/* <Item num="1" content={obj}></Item> */}
    // </div>
    //  <div className='container'>
    //    {/* <RedCub></RedCub> */}
